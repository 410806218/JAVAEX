...
import tankwariii.MoveableObject;
...
//	}
	...
	public Missile fire(Color color) {
		Missile missile = new Missile(this.getCenterX()-5 ,
				this.getCenterY()-50, 10, 10, color, this);
		missile.setDirection(this.getDirection());
                 switch(this.getDirection()){
                    case KeyEvent.VK_LEFT :
                        missile.setDirection('l');
                        break;
                    case KeyEvent.VK_RIGHT :
                        missile.setDirection('u');
                        break;
...
/*	public void move(int dir) {
	...
	private int[] allDir = {KeyEvent.VK_UP, KeyEvent.VK_RIGHT, KeyEvent.VK_LEFT,KeyEvent.VK_DOWN};
